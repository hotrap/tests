...
function run-rocksdb-fd {
	...
	./test-rocksdb-fd-110GB-replay.sh $prefix-load $prefix-run $DIR "--export_ans_xxh64 $2"
...
function run-hotrap {
	...
	echo Result directory: $DIR
	prefix=../../YCSB-traces/$1
	./test-hotrap-110GB-replay.sh $prefix-load $prefix-run $DIR "--export_ans_xxh64 $3"
