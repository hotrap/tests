#!/usr/bin/env bash
if [[ $# < 3 || $# > 4 ]]; then
	echo Usage: $0 workload-file output-dir sd-size [extra-kvexe-args]
	exit 1
fi
set -e
set -o pipefail
