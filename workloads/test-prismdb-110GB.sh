...
cp $workspace/testdb/cd/{a*,b*,v*,d*,e*,f*,h*,g*,i*,j*,k*,l*,o*,p*,q*,r*,s*,t*,u*,v*,w*,x*,y*,z*,n*,m*,LOG,log.txt,cpu,first-level-in-sd,progress,promoted-*,rocksdb-stats.txt,period_stats,latency*,mem} $DIR/
