...
cd db
mv LOG rocksdb-stats*.txt latency-* first-level-in-cd period_stats progress cpu cputimes mem info.json compaction-stats timers worker-cpu-nanos rand-read-bytes "$DIR"/
