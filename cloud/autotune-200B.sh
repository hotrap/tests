...
function run-hotrap {
	...
	ssh $user@$IP -o ServerAliveInterval=60 "source ~/.profile && cd tests/workloads && ./test-hotrap-110GB.sh ../config/$workload ../../data/$workload/$version 5.5GB 1.65GB \"--optimize_filters_for_hits --enable_dynamic_vc_param_in_lsm --enable_dynamic_only_vc_phy_size\""
