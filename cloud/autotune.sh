...
cloud-run run-hotrap "ycsbc_uniform_110GB_165GB" promote-accessed
cloud-run run-hotrap "read_0.75_insert_0.25_hotspot0.05_110GB_165GB" no-retain
cloud-run run-hotrap "read_0.75_insert_0.25_hotspot0.05_110GB_165GB" no-promote-by-compaction
wait
