...
def calc(data_dir):
    ...
    promoted = num_bytes['by-flush'] + num_bytes['by-compaction']
    retained = num_bytes['2fdlast'] - num_bytes['by-compaction']
