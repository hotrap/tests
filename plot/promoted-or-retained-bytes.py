...
plt.plot(time, num_bytes['by-compaction'], linewidth=0.5, marker='s', markersize=markersize, markevery=markevery)
...
plt.legend(['By flush', 'By compaction', '2fdlast', '2sdfront'], frameon=False, fontsize=8, loc=(0, 0.55))
plt.xlabel('Time (Seconds)', fontsize=8)
plt.ylabel('Bytes', fontsize=8)
plt.tight_layout()
