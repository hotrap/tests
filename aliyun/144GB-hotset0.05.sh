...
workloads=(
	...
	"ycsbc_hotspot0.05_144GB"
	"ycsbc_hotspotshifting0.05_144GB"
	"ycsbc_uniform_144GB"
	"ycsbc_zipfian_144GB"
...
function run_hotrap_1 {
	setup $1 $2 $3
	ssh root@$IP -o ServerAliveInterval=60 "source ~/.profile && cd tests/workloads && ./test-hotrap-144GB.sh ../config/$1 ../../data/$1/$2 16GB 7.2GB"
	rsync -zPrt -e ssh root@$IP:~/data/$1 $output_dir/
